    ...
    <div className="min-h-screen flex items-center justify-center bg-[#071320] relative overflow-hidden">
      ...
      <form className="relative z-10 w-[420px] rounded-[28px] border border-white/10 bg-white/5 backdrop-blur-2xl p-8 shadow-[0_0_40px_rgba(0,0,0,0.4)]" onSubmit={handelSubmit}>
        ...
        <div className="mb-4">
          ...
          <input className="mt-2 w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-white placeholder:text-slate-500 outline-none focus:border-cyan-400 transition" type="email" name="email" placeholder="Enter your email" onChange={handelChange}/>
        </div>
        {/* password */}
        <div className="mb-6">
          <label className="text-sm text-slate-300">Password</label>
          <input className="mt-2 w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-white placeholder:text-slate-500 outline-none focus:border-cyan-400 transition" type="password" name="password" placeholder="Enter your password" onChange={handelChange}/>
        </div>
